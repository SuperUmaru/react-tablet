...
import { ChevronLeft, ChevronRight, LoaderCircle, RotateCcw, Search, UserPlus } from 'lucide-react';
...
export function PatientsPage() {
  ...
  const changeMode = (value:LoadingMode) => { setMode(value); setPage(0); window.scrollTo({ top:0,behavior:'smooth' }); };
